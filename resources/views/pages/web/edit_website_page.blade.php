        ...
        <div class="order_details">
          <div class="card">
            ...
            <div class="card-body">
              ...
              @endif
              <form id="editContentForm" method="post" action="{{ route('update_website_page') }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <input type="title" name="title" class="form-control" id="page_title" placeholder="Title (English)" value="{{ $pageContent->title }}" readonly>
                        @if($errors->has('title'))
                    ...
                    <div class="col-12 position-relative">  
                      ...
                      <textarea   id="content"  class="description" name="content">{{ $pageContent->content }}</textarea>
                     <div id="charNum"></div>
...
<!-- added later for test -->
 ...
 <script>
    $(document).ready(function() {
      ...
      // content
      // var editors=  CKEDITOR.replace( 'content', {
