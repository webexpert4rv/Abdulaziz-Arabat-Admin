        ...
        <div class="order_details">
          <div class="card">
            ...
            <div class="card-header alert d-flex justify-content-between align-items-center">
              <h3>{{ __('adminlte::adminlte.blogs') }}</h3>
            
              <a class="btn btn-sm btn-success" href="{{route('blogs.create')}}">{{ __('adminlte::adminlte.add-blog') }}</a>
                ...
                <thead>
                  ...
                  @foreach($getData as $key=>$data)
                    ...
                    <tr class="remove_region{{$data->id}}">
                        ...
                        <td>
                           <img  src="{{env('STORAGE_PATH')}}/{{$data->blog_image}}">
                        ...
                        <td>
                            ...
                            <a class="action-button" title="Edit" href="{{route('blogs.edit',$data->id)}}"><i class="text-warning fa fa-edit"></i></a>
                             <a class="action-button" title="View" href="{{route('blogs.show',$data->id)}}"><i class="text-primary fa fa-eye"></i></a>
