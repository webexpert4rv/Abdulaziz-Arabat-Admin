    ...
    <div class="col-md-12">
        <div class="card">
          <div class="card-header alert d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-sm btn-success" style="margin-right:20px;" href="download-past-invoice">Download Past Invoice</a>
                                      ...
                                      <div class="col-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input autocomplete="off" type="text" disabled class="form-control" id="user_contact_number" name="user_contact_number" placeholder="Enter User Contact Number" autocomplete="off">
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input autocomplete="off" readonly type="number" class="form-control" id="driver_contact_number" name="driver_contact_number" placeholder="Enter Driver Contact Number" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="form-group form-group-width w-100">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input autocomplete="off" type="text" class="form-control" id="receivers_name" name="receivers_name" placeholder="Enter Reciever Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input autocomplete="off" type="number" class="form-control" id="receiver_number" name="receiver_number" placeholder="Enter Reciever Contact Number" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
