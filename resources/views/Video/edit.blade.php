                ...
                <div class="order_details">
                    <div class="card">
                        <div class="card-header alert d-flex justify-content-between align-items-center">
                            <h3>{{ __('adminlte::adminlte.edit_video') }}</h3>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.video_title_name') }}" name="video_title" class="form-control" id="video_title" value="{{$data->video_title}}" >
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.arabic_video_title') }}" name="arabic_video_title" class="form-control" id="arabic_video_title" value="{{$data->arabic_video_title}}" >
