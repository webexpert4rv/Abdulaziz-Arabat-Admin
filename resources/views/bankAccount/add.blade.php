                ...
                <div class="order_details">
                    <div class="card">
                        <div class="card-header alert d-flex justify-content-between align-items-center">
                            <h3>{{ __('adminlte::adminlte.bank-account') }}</h3> 
                        ...
                        @endif
                        <form id="editPricingForm" method="post", action="{{ route('bank-account.store') }}">
                            @csrf
                            <div class="card-body">                
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.vendor_name') }}" name="vendor_name" class="form-control" id="vendor_name" maxlength="100" >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.bank_name') }}" name="bank_name" class="form-control" id="bank_name" maxlength="100" >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.account_number') }}" name="account_number" class="form-control" id="account_number" maxlength="100" >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{ __('adminlte::adminlte.iban_no') }}" name="iban_no" class="form-control" id="iban_no" maxlength="100" >
