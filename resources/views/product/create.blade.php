        ...
        <div class="order_details">
          <div class="card">
            <div class="card-header alert d-flex justify-content-between align-items-center">
              <h3>{{ __('adminlte::adminlte.add_product') }}</h3>
              ...
              @endif
              <form id="editPricingForm" method="post", action="{{ route('product.store') }}">
                @csrf
                <div class="card-body">                
                  <div class="row">
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                      <div class="form-group">
                        ...
                        <input type="text"   name="arabic_name" placeholder="Arabic Name" class="form-control" id="arabic_name" maxlength="100" >
                        @if($errors->has('name'))
