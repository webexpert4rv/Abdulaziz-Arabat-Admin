                        ...
                        <form id="editPricingForm" method="post", action="{{ route('setting') }}">
                            ...
                            <div class="card-body">                
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label for="radius"> Duration of RFQ <span class="text-danger"> *</span></label> 
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label for="radius">User Timer Duration for Accpting the quote </label> 
                                            <select name="user_timer_duration" class="form-control" id="user_timer_duration">                                                
                                                @for ($h=1; $h <=6 ; $h++)                             
                                                    <option value="{{$h}}" @if($h==$setting->user_timer_duration) selected @endif>{{$h}} hour</option>
                                                @endfor  
                                            </select>
                                            <div id ="email_error" class="error"></div>
                                            @if($errors->has('user_timer_duration'))
                                                <div class="error">{{ $errors->last('user_timer_duration') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-3">
