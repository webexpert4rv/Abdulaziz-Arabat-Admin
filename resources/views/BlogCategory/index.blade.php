        ...
        <div class="order_details">
          <div class="card">
            ...
            <div class="card-header alert d-flex justify-content-between align-items-center">
              <h3>{{ __('adminlte::adminlte.blog-category') }}</h3>
            
              <a class="btn btn-sm btn-success" href="{{route('blog-category.create')}}">{{ __('adminlte::adminlte.add-blog-category') }}</a>
                  ...
                  @foreach($getData as $key=>$data)
                    <tr class="remove_region{{$data->id}}">
                        ...
                        <td>
                            ...
                            <a class="action-button" title="Edit" href="{{route('blog-category.edit',$data->id)}}"><i class="text-warning fa fa-edit"></i></a>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
  ...
  function updateStatus(id){ 
    ...
    $.ajax({
        type: 'POST',
        url: "{{route('update.blog-category.status')}}",
        data: {
            "_token"      : "{{ csrf_token() }}",
            "status"      : status,
            "id"          : id,
