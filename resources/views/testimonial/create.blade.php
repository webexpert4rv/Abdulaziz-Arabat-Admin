        ...
        <div class="order_details">
            <div class="card">
              ...
              <div class="card-body">
                ...
                @endif
                <form id="addTestimonialForm" method="post", action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">                
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input type="text" placeholder="Name (English)" name="name" class="form-control" id="name" maxlength="100">
                            @if($errors->has('name'))
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input type="text" placeholder="Name (Arabic)" name="arabic_name" class="form-control" id="arabic_name" maxlength="100">
                        ...
                        <div class="col-6 company_div" >
                          <div class="form-group position-relative">
                            ...
                            <textarea type="text" rows="6" onkeyup="countChar(this)" placeholder="Description (English)" name="description" class="form-control" id="company" maxlength="500"></textarea> 
                            <div id="charNum"></div>
                        ...
                        <div class="col-6 company_div" >
                          <div class="form-group position-relative">
                            ...
                            <textarea type="text" rows="6" onkeyup="countChar(this)" placeholder="Description (Arabic)" name="arabic_description" class="form-control" id="arabic_description" maxlength="500"></textarea> 
                            <div id="charNum"></div>
