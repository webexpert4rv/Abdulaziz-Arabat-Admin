        ...
        <div class="order_details">
          <div class="card">
            ...
            <div class="card-header alert d-flex justify-content-between align-items-center">
              ...
              <a href="create-transporter" style="margin-right:20px;">Add New Transporter</a>
  ...
  swal({
    ...
    if (willDelete) {
      ...
      success: function(response) {
        ...
        swal(
          '',
          'We have sent an activation email to your address. Please check your inbox and spam folder.It may take a few minutes for the email to arrive.',
          'info'
        );
