        ...
        <div class="order_details">
          <div class="card">
            ...
            <div class="card-header alert d-flex justify-content-between align-items-center">
              <h3>{{ __('adminlte::adminlte.faq_title') }}</h3>
            
              <a class="btn btn-sm btn-success" href="{{route('faq.create')}}">{{ __('adminlte::adminlte.add-faq') }}</a>
            ...
            <div class="card-body">
              ...
              <table style="width:100%" id="exampleTable" class="table table-bordered table-hover datatable">
                <thead>
                  <tr>
                    <th >Sr.No.</th>
                    <th>{{ __('adminlte::adminlte.faq_question') }}</th>                  
                    <th>{{ __('adminlte::adminlte.faq_question_ar') }}</th>
                    ...
                    <tr class="remove_region{{$data->id}}">
                      ...
                      <!--   <td>
                        ...
                        <td>
                            ...
                            <a class="action-button" title="Edit" href="{{route('faq.edit',$data->id)}}"><i class="text-warning fa fa-edit"></i></a>
