        ...
        <div class="order_details">
          <div class="card">
            <div class="card-header alert d-flex justify-content-between align-items-center">
              <h3>{{ __('adminlte::adminlte.edit_sub_region') }}</h3>
            ...
            @endif
            <form id="editPricingForm" method="post", action="{{ route('sub-region.update',$subRegion->id) }}">
              @csrf
              @method('PUT')
              <div class="card-body">                
                <div class="row">
                 ...
                 <div class="col-12">
                  <div class="form-group">
                    ...
                    <select name="region_id" class="form-control" id="region">
                      ...
                      <option  {{ $subRegion->region_id==$region->id?'selected':''}}  value="{{@$region->id}}">{{@$region->name}}</option>
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="Name" name="name" class="form-control" value="{{$subRegion->name}}" id="name" maxlength="100" >
                    @if($errors->has('name'))
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="Arabic Name" name="arabic_name" class="form-control" value="{{$subRegion->arabic_name}}" id="arabic_name" maxlength="100" >
                    @if($errors->has('name'))
                    <div class="error">{{ $errors->first('name') }}</div>
                    @endif
                  </div>
                 ...
                 <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text"  name="lat" class="form-control" value="{{$subRegion->lat}}" id="lat" maxlength="100" >
                    @if($errors->has('name'))
                    <div class="error">{{ $errors->first('name') }}</div>
                    @endif
                  </div>
                 ...
                 <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="" name="long" class="form-control" value="{{$subRegion->long}}" id="long" maxlength="100" >
                    @if($errors->has('name'))
                    <div class="error">{{ $errors->first('name') }}</div>
                    @endif
                  </div>
